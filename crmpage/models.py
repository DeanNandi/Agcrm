...
class Candidate(models.Model):
    ...
    child_date_of_birth = models.CharField(max_length=255, blank=True, null=True)
    ...
    child_date_of_birth2 = models.CharField(max_length=255, blank=True, null=True)
    ...
    University_Name_secondary = models.CharField(max_length=255, blank=True, null=True)
    ...
    University_Name_tertiary = models.CharField(max_length=255, blank=True, null=True)
    ...
    College_Name_secondary = models.CharField(max_length=255, blank=True, null=True)
    ...
    College_Name_tertiary = models.CharField(max_length=255, blank=True, null=True)
    ...
    Hours_worked = models.CharField(max_length=255, blank=True, null=True)
    ...
    Ward_name_secondary = models.CharField(max_length=255, blank=True, null=True)
    Hours_worked_secondary = models.CharField(max_length=255, blank=True, null=True)
    ...
    Institution_name_tertiary = models.CharField(max_length=255, blank=True, null=True)
    Ward_name_tertiary = models.CharField(max_length=255, blank=True, null=True)
    Hours_worked_tertiary = models.CharField(max_length=255, blank=True, null=True)
...
class Sheet2Application(models.Model):
    ...
    level_of_german = models.CharField(max_length=255, blank=True, null=True)
    enrol_in_course = models.CharField(max_length=255, blank=True, null=True)
    questions = models.CharField(max_length=255, blank=True, null=True)
    time_for_class = models.CharField(max_length=255, blank=True, null=True)
    online_or_physical = models.CharField(max_length=255, blank=True, null=True)
    days_for_class = models.CharField(max_length=255, blank=True, null=True)
